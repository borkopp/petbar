/**
 * Transliteration utility for Macedonian language
...
/**
 * Normalizes text for search by converting to lowercase and handling both Latin and Cyrillic
 * @param text - The text to normalize
 * @returns An array of normalized versions (original, Latin, and Cyrillic)
 */
export function normalizeForSearch(text: string): string[] {
  ...
  // Return all versions for flexible searching
  return [lowerText, cyrillicVersion, latinVersion].filter((v, i, a) => a.indexOf(v) === i);
} 